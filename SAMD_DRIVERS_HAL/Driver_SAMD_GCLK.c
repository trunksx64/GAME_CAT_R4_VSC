...
void vDriver_SAMD_GCLK_CONFIGURE(void) {
    ...
    GCLK_REGS->GCLK_GENDIV = (
            GCLK_GENDIV_ID(0U) | // Generic Clock Generator Selection
            GCLK_GENDIV_DIV(1U)); // Division Factor 

    /* Configuration ::: GCLK :: GENCTRL */
    GCLK_REGS->GCLK_GENCTRL = (
            GCLK_GENCTRL_RUNSTDBY(pdCLR) | // Run in Standby
    ...
    /* Configuration ::: GCLK :: GENDIV */
    GCLK_REGS->GCLK_GENDIV = (
            GCLK_GENDIV_ID(1U) | // Generic Clock Generator Selection
    ...
    /* Configuration ::: GCLK :: GENDIV */
    GCLK_REGS->GCLK_GENDIV = (
            GCLK_GENDIV_ID(2U) | // Generic Clock Generator Selection
    ...
    /* Configuration ::: GCLK :: GENDIV */
    GCLK_REGS->GCLK_GENDIV = (
            GCLK_GENDIV_ID(3U) | // Generic Clock Generator Selection
    ...
    /* Configuration ::: GCLK :: GENDIV */
    GCLK_REGS->GCLK_GENDIV = (
            GCLK_GENDIV_ID(4U) | // Generic Clock Generator Selection
    ...
    /* Configuration ::: GCLK :: GENDIV */
    GCLK_REGS->GCLK_GENDIV = (
            GCLK_GENDIV_ID(5U) | // Generic Clock Generator Selection

#ifndef DRIVER_SAMC_SERCOM4_SPIM_H
#define DRIVER_SAMC_SERCOM4_SPIM_H
...
/******************************************************************************/
#define SERCOM4_SPI_BAUD_RATE_CALC(F_OSC, F_CLK) (uint08_t)((F_OSC / (2U * F_CLK)) - 1U)
#define SERCOM4_SPI_BAUD_RATE                    (100000UL) // ((F_Clock/(2*F_Baud))-1)
...
#endif /* DRIVER_SAMC_SERCOM4_SPIM_H */

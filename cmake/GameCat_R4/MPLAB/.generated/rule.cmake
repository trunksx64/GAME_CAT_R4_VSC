...
function(GameCat_R4_MPLAB_default_XC32_assemble_rule target)
    set(options
        "-g"
        "${ASSEMBLER_PRE}"
...
function(GameCat_R4_MPLAB_default_XC32_assembleWithPreprocess_rule target)
    set(options
        "-x"
        "assembler-with-cpp"
        "-g"
...
function(GameCat_R4_MPLAB_default_XC32_compile_rule target)
    set(options
        "-g"
        "${CC_PRE}"
        "-x"
...
function(GameCat_R4_MPLAB_default_XC32_compile_cpp_rule target)
    set(options
        "-g"
        "${CC_PRE}"
        "${DEBUGGER_NAME_AS_MACRO}"
...
function(GameCat_R4_MPLAB_link_rule target)
    set(options
        "-g"
        "${MP_EXTRA_LD_PRE}"
